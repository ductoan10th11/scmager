...
export const NOTIFICATION_TYPES = [
  'DOCUMENT_ASSIGNED_TO_DEPARTMENT',
  'DOCUMENT_REASSIGNED_DEPARTMENT',
  'TASK_ASSIGNED',
  'TASK_REASSIGNED',
  ...
  'WORK_DECLARATION_APPROVED',
  'WORK_DECLARATION_RETURNED',
  'WORK_DECLARATION_RESCHEDULED',
  'WORK_DECLARATION_POINT_ADJUSTMENT_REQUESTED',
  'WORK_DECLARATION_POINT_ADJUSTMENT_FORWARDED',
  'WORK_DECLARATION_POINT_ADJUSTMENT_APPROVED',
  'WORK_DECLARATION_POINT_ADJUSTMENT_REJECTED',
  'DOCUMENTS_AWAITING_SCORE',
