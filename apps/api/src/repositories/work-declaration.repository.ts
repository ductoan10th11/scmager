...
const POPULATE_WORK_DECLARATION = [
  ...
  { path: 'assignedBy', select: '_id username fullName position email role department' },
  { path: 'sourceDocument', select: '_id externalDocumentId observation.soKyHieu observation.subject observation.dueDate management.overrides management.manualScore statusSync' },
